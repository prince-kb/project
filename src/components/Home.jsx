  ...
  return (
    <div className='w-full '>
      ...
      <div className='flex flex-col md:flex-row justify-around my-10 px-4 md:px-0'>
        <div className="h-[40vh] md:h-[40vh] w-full md:w-[28vw] rounded-xl shadow-md shadow-black mb-4 md:mb-0 transition-all   duration-200 ease-out hover:scale-105 hover:-translate-y-2 cursor-pointer border-2 border-[#4a4a4a]">
        ...
        <div className="h-[40vh] w-full md:w-[28vw] rounded-xl mb-4 md:mb-0 shadow-md shadow-black transition-all   duration-200 ease-out hover:scale-105 hover:-translate-y-2 cursor-pointer">
      ...
      <div className='flex flex-col md:flex-row justify-around my-10 px-4 md:px-0'>
        <div className="h-[40vh] md:h-[40vh] w-full md:w-[28vw] rounded-xl shadow-md shadow-black mb-4 md:mb-0 transition-all   duration-200 ease-out hover:scale-105 hover:-translate-y-2 cursor-pointer">
